package com.mth.androiddaemonservice.receiver;
...
public class WakeReceiver extends BroadcastReceiver {
     ...
     * 灰色保活手段唤醒广播的action
     */
    public final static String GRAY_WAKE_GRAY_ACTION = "com.wake.gray";
    /**
     * 黑色保活
     */
    public final static String GRAY_WAKE_BLACK_ACTION = "com.wake.black";

    @Override
    public void onReceive(Context context, Intent intent) {
        String action = intent.getAction();
        if (GRAY_WAKE_GRAY_ACTION.equals(action) || GRAY_WAKE_BLACK_ACTION.equals(action)) {
            Log.i(TAG, "wake !! wake !! ");
