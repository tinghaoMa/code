package com.mth.androiddaemonservice.service;
...
import com.mth.androiddaemonservice.receiver.WakeReceiver;
...
public class GrayService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        alarmIntent.setAction(WakeReceiver.GRAY_WAKE_GRAY_ACTION);
